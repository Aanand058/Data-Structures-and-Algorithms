...
class ContactBookTest {
    ...
    public void testSearchContactByPhone() {
        ...
        // Step i: create a contact
        Contact testContactForPhone = new Contact("Toni", "184048");

        // Step ii: add the contact to the book
        contactBook.addContact(testContactForPhone);

        // Step iii: search by phone number
        Contact result = contactBook.searchContactByPhone("184048");

        // Step iv: assert not null
        assertNotNull(result);

        // Step v: assert name and phone number match
        assertEquals(testContactForPhone.getName(), result.getName());
        assertEquals(testContactForPhone.getPhoneNumber(), result.getPhoneNumber());
