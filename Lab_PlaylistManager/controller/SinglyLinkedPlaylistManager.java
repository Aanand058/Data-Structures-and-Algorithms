package Lab_PlaylistManager.controller;

import Lab_PlaylistManager.model.*;

/**
 * The SinglyLinkedPlaylistManager class is responsible for managing a playlist
 * of songs using a Singly linked list structure.
 * It provides methods to add, remove, and navigate through songs in the
 * playlist.
 * This class supports checking for duplicate songs, moving to the next or
 * previous song,
...
public class SinglyLinkedPlaylistManager {
    ...
    public void addFavoriteSong(Song newSong) {
        ...
        // If empty, set the new node as the head of the list, initialize the current
        // node to the head.
    ...
    public void removeFavoriteSong(int index) {
        // TODO 6: Check if the index is less than 1. If so, print “Invalid index.” and
        // return.
        if (index < 1) {
        ...
        // TODO 7: Check if the playlist is empty (head == null). If so, print “Playlist
        // is empty.” and return.
         // TODO 7: Check if playlist is empty
         if (head == null) {
            System.out.println("Playlist is empty.");
            return;
        }

        // TODO 8: If the index is 1, set head to head.next, print the title of the
        // removed song, and return.
        if (index == 1) {
        ...
        // TODO 9: Traverse the playlist using a loop, keeping track of current,
        // previous, and count.
        Node previous = null;
        Node temp = head;
        int count = 1;
        ...
        // TODO 11: If a valid node is found, adjust previous.next to remove the current
        // node and print the title of the removed song.

        System.out.println("Removed song: " + temp.song.getTitle());
    ...
    public void displayFavoriteSongs() {
        ...
        // TODO 14: use a while loop to iterate through the playlist, printing each
        // song’s index and details.
        // TODO 15: inside the loop, increment the index and update current to
        // current.next.
    ...
    public void playNextFavoriteSong() {
        // TODO 16: check if there is no next song by verifying if current == null or
        // current.next == null.
    ...
    public void playPreviousFavoriteSong() {
        ...
        // If `current` is `null` or `current` is pointing to `head`, there is no
